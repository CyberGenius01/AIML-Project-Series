...
def load_conversations():
    dataset = pd.read_csv(r'C:\\users\\ritesh\\Desktop\\chatbot\\Data.tsv', delimiter='\t', encoding='latin-1', header=None).values
    inputs = []
    outputs = []
...
def train_and_save(model):
    ...
    filename = r'C:\\users\\ritesh\\Desktop\\chatbot\\ModelT.h5'
    model.save(filename)
    with open(r'C:\\users\\ritesh\\Desktop\\chatbot\\historyT.history', 'wb') as fout:
...
def visualization():
    with open(r'C:\\users\\ritesh\\Desktop\\chatbot\\historyT.history', 'rb') as fin:
...
def evaluate(sentence):
    ...
    r'C:\\users\\ritesh\\Desktop\\chatbot\\ModelT.h5',
    custom_objects={
...
print(f"Bot: {predict('Hi, how are you?')}")
print('You: Should I study smartly, or hardly?')
print(f"Bot: {predict('Should I study smartly, or hardly?')}")
print('You: Are you a bot?')
print(f"Bot: {predict('Are you a bot?')}")
print('You: Nice to meet you!')
print(f"Bot: {predict('Nice to meet you!')}")